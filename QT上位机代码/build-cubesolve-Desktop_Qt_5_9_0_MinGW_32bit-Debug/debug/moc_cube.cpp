...
QT_MOC_LITERAL(1, 5, 13), // "updatePattern"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "endRotating"

    },
    "Cube\0updatePattern\0\0endRotating"
};
...
void Cube::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updatePattern(); break;
        case 1: _t->endRotating(); break;
        default: ;
        }
        ...
        {
            typedef void (Cube::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cube::updatePattern)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Cube::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cube::endRotating)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Cube::updatePattern()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Cube::endRotating()
{
