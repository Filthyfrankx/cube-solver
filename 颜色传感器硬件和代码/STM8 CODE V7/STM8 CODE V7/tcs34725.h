...
#define TCS_SDA0_PIN          4  //PC4
#define TCS_SDA1_PIN          4  //PF4
#define TCS_SDA2_PIN          7  //PB7
#define TCS_SDA3_PIN          6  //PB6
#define TCS_SDA4_PIN          5  //PB5
#define TCS_SDA5_PIN          4  //PB4
#define TCS_SDA6_PIN          3  //PB3
#define TCS_SDA7_PIN          2  //PB2
#define TCS_SDA8_PIN          1  //PB1
#define TCS_SDA9_PIN          0  //PB0

#define TCS_SCL_PIN           2   //PD2

#define TCS_SCL_DIR_OUT()    {PD_DDR |= (1<<TCS_SCL_PIN); /*  设置为输出 */PD_CR1 |= (1<<TCS_SCL_PIN); /* 推挽输出 */PD_CR2 &= ~(1<<TCS_SCL_PIN); /* 在输出模式 DDR=1 时，速度 2MHz */}//输出模式

#define TCS_SCL_SET           PD_ODR |= (1<<TCS_SCL_PIN) /* H */
#define TCS_SCL_RESET         PD_ODR &= ~(1<<TCS_SCL_PIN) 

unsigned char TCS34725_Init(u8 ch);
void TCS34725_Enable(u8 ch);
unsigned int TCS34725_GetChannelData(u8 ch,unsigned char reg);
void TCS34725_Init_All(void);
