...
#include "../../cubesolve/mypushbutton.h"
...
QT_MOC_LITERAL(4, 29, 11), // "clickedSlot"
QT_MOC_LITERAL(5, 41, 7) // "checked"

    },
    "MyPushButton\0myClicked\0\0text\0clickedSlot\0"
    "checked"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->myClicked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyPushButton::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyPushButton::myClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyPushButton::myClicked(const QString & _t1)
{
